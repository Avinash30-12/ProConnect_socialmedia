...
import { createPost, deletPost, getAllComments, getAllPosts, incrementPostLike, postComment } from '../../config/redux/action/postAction'
        ...
        <div className={Styles.scrollComponent}>
           <div className={Styles.wrapper}>
             <div className={Styles.createPostContainer}>
                  ...
                  <textarea onChange={(e)=> setPostContent(e.target.value)} value={postContent} className={Styles.textArea} placeholder="what's in your mind?"></textarea>
                                   ...
                                   <div>
                                     <div style={{display:"flex" , gap:"1.2rem" , justifyContent:"space-between"}}>
                                      ...
                                      {post.userId._id === authState.user.userId._id &&
                                       <div onClick={ async()=>{
                                          await dispatch(deletPost({post_id : post._id }))
          ...
          dispatch(resetPostId())
              ...
              <div onClick={(e)=>{
                ...
                <div className={Styles.postCommentContainer}>
                    <input type="text" value={commentText} onChange={(e)=> setCommentText(e.target.value)} placeholder='comments'/>
                    <div onClick={ async()=>{
